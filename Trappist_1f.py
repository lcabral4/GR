...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  6 11:45:12 2022
...
e = 0.01
#a = 58000000000
a = 0.03849*1.496*10**(11)
h = G*3*M*a*(1-e**2)/ c**2
f = h* 4.4684e-23
print(f, 'lambda value for code')
...
def go(animate = True):                     # default: True
    r, v = np.array([0.039, 0.0, 0.]), np.array([0.0, 9.5, 0.]) # init r, v for merc
...
lamb = 1.0124322289876674e-10 #Trappist -1f
# lamb = 2.1E-8 #Venus
# lamb = 2.9E-8 #Earth
'''
