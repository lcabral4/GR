...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  4 17:04:26 2022
...
def go(animate = True):                     # default: True
    r, v = np.array([0.0116554, 0.0, 0.]), np.array([0.0, 17.2747510, 0.]) # init r, v for merc
...
lamb = 3.035455422841694e-11 #Trappist -1b
# lamb = 2.1E-8 #Venus
# lamb = 2.9E-8 #Earth
'''
